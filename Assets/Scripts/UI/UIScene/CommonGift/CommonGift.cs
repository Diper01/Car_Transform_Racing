...
public class CommonGift : UIBoxBase {
	...
	public override void Init ()
	{
		...
		string costString = PayBuild.PayBuildPayManage.Instance.GetProductPriceString((int)commonGiftType);
		chargingInfo.text = costString + PayJsonData.Instance.GetGiftTitle(commonGiftType) + " and open a lot of game packs";//cost.ToString() + "usd" 
