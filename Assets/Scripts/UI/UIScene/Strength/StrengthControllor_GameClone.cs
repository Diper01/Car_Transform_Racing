...
public class StrengthControllor_GameClone : UIBoxBase
{
    public static StrengthControllor_GameClone Instance;
    ...
    public override void Init()
    {
        ...
        //AndroidPackage.instance.RequestVideoAds();
    }
    ...
    private void InitData()
    {
        ...
        Transform itemTran;
        StrengthItem_GameClone itemScript;

        int itemCount = 4;

        for (int i = 1; i <= itemCount; ++i)
        {
            itemTran = spUIItems.Spawn("Strength_bg");
            itemTran.parent = ItemContainer;
            //itemTran.localPosition = new Vector3(0, 60 - ItemLength * (i - 1), 0);
            //itemTran.localScale = Vector3.one;
            itemScript = itemTran.GetComponent<StrengthItem_GameClone>();
            itemScript.Init();
