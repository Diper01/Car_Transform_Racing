...
public class CharacterDetailControllor_GameClone : UIBoxBase {

	public static CharacterDetailControllor_GameClone Instance;
	...
	public PagePoint_GameClone pagePoint;
	public GameObject CoinTypeGO, JewelTypeGO;
	public Image CoinTypeCostTypeImage, JewelTypeCostTypeImage;
    public Sprite coinIcon, jewelIcon;
	public Text CoinTypeCostCountText,JewelTypeCostCountText, CoinTypeBtnText,JewelTypeBtnText;
	public Text ZaohuanCountText;
	...
	public Text textRunSpeedValue, textAccelerationValue, textShapeTimeValue;
	public Image imageRunSpeedCurLevel, imageRunSpeedNextLevel, imageAccelerationCurLevel, imageAccelerationNextLevel, imageShapeTimeCurLevel, imageShapeTimeNextLevel;
	//public Image imageMaxRunSpeedIcon, imageAccelerationIcon, imageShapeTimeOilIcon;
	public Text textBuff1Name, textBuff1Info;
	public Image imageBuff1Icon;
    public Sprite[] buffSprites;

    public Text enableDesc1Text;
	...
	public override void Init ()
	{
		...
		LeftContent.localPosition = GlobalConst.LeftHidePos;//проверить позиции
...
//			}
	...
	public override void Show ()
	{
		...
		if (GlobalConst.IsSignIn && PlayerData.Instance.GetUIGuideState (UIGuideType.CharaterDetailGuide) && PlayerData.Instance.GetCurrentChallengeLevel () == 3) {
			...
			{
				UIGuideControllor_GameClone.Instance.Show (UIGuideType.CharaterDetailGuide);
				UIGuideControllor_GameClone.Instance.ShowBubbleTipByID(4);
			}
		}
		base.Show();
		...
		if (GlobalConst.SceneName == SceneType.UIScene) {
			...
			goLeftButton.transform.Find("BtnImage").GetComponent<Image>().color = Color.white;
			goRightButton.transform.Find("BtnImage").GetComponent<Image>().color = Color.white;
		}
		else
		{
			...
			goLeftButton.transform.Find("BtnImage").GetComponent<Image>().color = new Color(0.5f, 0.5f, 0.5f, 1);
			goRightButton.transform.Find("BtnImage").GetComponent<Image>().color = new Color(0.5f, 0.5f, 0.5f, 1);
...
//		if(modelLevel <= AutoGiftChecker.MaxModelLevelOpenOneKeyToFull)
	...
	private void SetButtonData()
	{
		...
		if(modelLevel == 0)
		{
			...
			if(upgradeType.CompareTo("Coin") == 0)
			{
                ...
                CoinTypeCostTypeImage.sprite = coinIcon;//.SetSprite (upgradeType.ToLower() + "_icon");
			...
			else
			{
				...
				JewelTypeCostTypeImage.sprite = jewelIcon;//.SetSprite (upgradeType.ToLower() + "_icon");
	...
	public void SetModelInfo(int Id)
	{
        ...
        //10-250/ 10-full, 250 - 0
        imageRunSpeedCurLevel.rectTransform.offsetMax = new Vector2(250-(240* fRunSpeed / fMaxRunSpeed), 5);//witchcraft!!
        imageAccelerationCurLevel.rectTransform.offsetMax = new Vector2(250 - (240 * fAcceleration / fMAxAcceleration), 5);
        imageShapeTimeCurLevel.rectTransform.offsetMax = new Vector2(250 - (240 * fShapeTime / fMaxShapeTime), 5);

        imageRunSpeedNextLevel.rectTransform.offsetMax = new Vector2(250 - (240 * fNextRunSpeed / fMaxRunSpeed), 5);
        imageAccelerationNextLevel.rectTransform.offsetMax = new Vector2(250 - (240 * fNextAcceleration / fMAxAcceleration), 5);
        imageShapeTimeNextLevel.rectTransform.offsetMax = new Vector2(250 - (240 * fNextShapeTime / fMaxShapeTime), 5);
		...
		imageBuff1Icon.sprite =System.Array.Find(buffSprites, b=>b.name==ModelData.Instance.GetLevelSkillIcon (Id));
	}
