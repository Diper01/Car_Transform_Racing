...
public class DailyMissionControllor : UIBoxBase {
    ...
    //{
    //    if(FindObjectOfType<MainInterfaceControllor>()!=null)
    //    foreach(EasyFontTextMesh item in FindObjectOfType<MainInterfaceControllor>().GetComponentsInChildren<EasyFontTextMesh>())
    //    {
