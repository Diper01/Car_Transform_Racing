...
public class PropertyDisplayControllor_GameClone : UIBoxBase {

	public static PropertyDisplayControllor_GameClone Instance;

	public Text StrengthCountText, StrengthRecoverCountTimeText, CoinCountText, JewelCountText;
	[HideInInspector]
	public int strengthCount, coinCount, jewelCount;


    private void Start() //Cheat
    {
        //PlayerData.Instance.SetItemNum(PlayerData.ItemType.Coin, 100000);
        //PlayerData.Instance.SetItemNum(PlayerData.ItemType.Jewel, 100000);
        //PlayerData.Instance.SetItemNum(PlayerData.ItemType.Strength, 100);
    }
	...
	private void ChangeLayer(Transform parentTran, int layer)
	{
		...
		//	StartCoroutine(PublicSceneObject.Instance.AddButtonsToSelectList(BoxAllButtonList));
	}
	...
	private int strengthRecoverLimit = 20; //体力自动回复的上限值
