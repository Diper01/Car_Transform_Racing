    ...
    public void SetEventLayer(EventLayer layer)
    {
        switch (layer)
        {
            case EventLayer.Nothing:
                ...
                PublicSceneObject.Instance.ChangeLayerEvent(0);
                break;
            case EventLayer.EveryThing:
                ...
                PublicSceneObject.Instance.ChangeLayerEvent(-1);
                break;
            case EventLayer.UI:
                ...
                PublicSceneObject.Instance.ChangeLayerEvent(1<<5);
                break;
            case EventLayer.FirstDialog:
                ...
                PublicSceneObject.Instance.ChangeLayerEvent(1 << 11);
                break;
            case EventLayer.SecondDialog:
                ...
                PublicSceneObject.Instance.ChangeLayerEvent(1 << 12);
                break;
            case EventLayer.ThirdDialog:
                ...
                PublicSceneObject.Instance.ChangeLayerEvent(1 << 13);
                break;
            case EventLayer.FourthDialog:
                ...
                PublicSceneObject.Instance.ChangeLayerEvent(1 << 14);
                break;
            case EventLayer.Guide:
                ...
                PublicSceneObject.Instance.ChangeLayerEvent(1 << 17);
                break;
        }
    }
}
