...
public class UIGuideControllor : UIBoxBase {
	...
	public GameObject goLevelInfoGuideBtn, goMainInterfaceUpgradeGuideBtn, goMainInterfaceStartGameGuideBtn, goCharaterDetailGuideBtn,goLeftRoleGuideBtn;
	public GameObject LevelInfoGuideGO, MainInterfaceUpgradeGuideGO, MainInterfaceStartGameGuideGO, CharaterDetailGuideGO, LeftRoleGuideGO, HandGO;
...
//	[HideInInspector][System.NonSerialized]public string upgradeRoleTip3 = "点击Use props吧！";
	...
	public void Show(UIGuideType guideType)
	{
		...
		//	//int  spId = GamePlayerUIControllor.Instance.spriteId; //
	...
	void MainInterfaceStartGameGuideBtnOnClick()
	{
		...
		if (GlobalConst.LeftRoleGuideEnabled) {
            //下一步教程
            LevelInfoControllor.guide = true;
	...
	void LeftRoleGuideBtnOnClick()
	{
        ...
        MainInterfaceControllor.guide = true;
        //下一步教程
