...
//		Debug.Log ("PlatformSetting_Init");
        ...
        PayVersionType = (PayVersionItemType)System.Enum.Parse(typeof(PayVersionItemType), PlayerData.Instance.GetPayVersionType()); //PayVersionItemType.GuangDian; - cheats 9999999
