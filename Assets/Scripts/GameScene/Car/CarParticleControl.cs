...
//		traceList[3].transform.localPosition = new Vector3(0.8f,0,1.1f);
	...
	public void PlayParticle(CarParticleType particleType, bool autoStop = false, float waitTime = 0)
	{
		...
		case CarParticleType.SpeedUp:
			particleTran = carParticlePool.Spawn ("FX_wudijiasu01_hg", transform.parent);//+ Можно еще больше упростить, убрав эффекты с обеих колёс, сделав 1
                break;
		...
		case CarParticleType.ShapeSpeedUp:
			particleTran = carParticlePool.Spawn ("FX_kaixinjiasu01_hg", transform.parent);//+Можно еще больше упростить, убрав эффекты с обеих колёс, сделав 1
                break;
