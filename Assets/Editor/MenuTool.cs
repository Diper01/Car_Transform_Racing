...
public class MenuTool {
	...
	[MenuItem(MenuRoot + "Redemption code generation function", false)]//兑换码生成功能
    static void ShowExchangeCodeWindow()
	{
		EditorWindow.GetWindowWithRect<ExchangeCodeEditor>(new Rect(Screen.width / 2, 100, 800, 500), true, "Redemption code function window", true).Show();//兑换码功能窗口
    }
