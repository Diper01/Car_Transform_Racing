...
public class tk2dTextMesh : MonoBehaviour, tk2dRuntime.ISpriteCollectionForceBuild
{
	...
	void Awake() 
	{
        //if (gameObject.GetComponent<LocalisedString>() == null)
        //    gameObject.AddComponent<LocalisedString>();
    ...
    void Update()
    {
       // GetComponent<tk2dTextMesh>().font = FindObjectOfType<EasyFontTextMesh>().FontType;
    }
