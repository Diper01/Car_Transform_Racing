...
public class RenderOnTop : MonoBehaviour {
	...
	[ContextMenu("Apply Depth")]
	void ApplyDepth () 
	{
		var mr = this.GetComponent<Renderer> ();
		var pr = this.transform.parent.GetComponent<Renderer> ();

		mr.sortingLayerID = pr.sortingLayerID;
		mr.sortingOrder = pr.sortingOrder + 1;
	}
